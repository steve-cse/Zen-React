...
export default function Dashboard() {
  ...
  useEffect(() => {
    const getPilates = async () => {
      const q = query(collection(fstore, "users"), where("uid", "==", currentUser.uid));
  ...
  return (
    <>
          ...
          {pilates.map((data) => {
              ...
              return (
                ...
                <div>
                    ...
                    curls={data.curls}
                    squats={data.squats}
                    lateral_raise={data.lateral_raise}
                    />
      ...
      <Button variant="link" onClick={() => navigate('/pilates-practice-beginner')}>
          Pilates
        </Button>
